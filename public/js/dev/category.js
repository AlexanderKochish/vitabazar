...
const filterButton = document.querySelector(".button--icon-filter");
const filterBlock = document.querySelector(".inner-cat__filter");
filterButton.addEventListener("click", () => {
  filterBlock.classList.toggle("open");
  filterButton.classList.toggle("filter-open");
});
